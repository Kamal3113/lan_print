...
//   Autogenerated({this.printerName, this.itemLength, this.template, this.data});
...
//   Data({this.type, this.data, this.printerName, this.individualPrint});
...
//     align = json['align'];
//     kitchenFooterText = json['kitchen_footer_text']== null? [] : List<String>.from(json["kitchen_footer_text"].map((x) => x));
